...
\subsection{Exemple d'application: Prédire si une personne aime le boisson ICE}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf1.png}
    \caption{Exemple illustratif : Prédire si une personne aime la ICE (1)}
    \label{fig:chap2_fig2}
\end{figure}

\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf2.png}
    \caption{Exemple illustratif : Prédire si une personne aime la ICE (2)}
    \label{fig:chap2_fig2}
\end{figure}

\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf3.png}
    \caption{Exemple illustratif : Prédire si une personne aime la ICE (3)}
    \label{fig:chap2_fig2}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf4.png}
    \caption{Tirage avec remise : chaque arbre reçoit un sample différent (63,2\% unique)}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf5.png}
    \caption{Un forêt aléatoire ayant 6 arbres}
    \label{fig:chap2_fig3}
\end{figure}

\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf_aggregation.jpeg}
    \caption{Gauche : vote majoritaire pour la classification. Droite : moyenne pour la régression}
    \label{fig:chap2_fig3}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{logos/code.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{logos/bagging vs boosting.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/rf_bootstrap_detail.jpeg}
    \caption{L'erreur OOB}
    \label{fig:chap2_fig3}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{Chapters/images/feature_importance1.png}
    \caption{mportance MDI (Gini) des variables}
    \label{fig:chap2_fig3}
\end{figure}
