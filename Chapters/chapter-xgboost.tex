...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapters/images/gradient_boosting_residuals.png}
    \caption{Illustration du principe additif du Gradient Boosting apprenant sur les erreurs résiduelles.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{Chapters/images/xgb_regularization.png}
    \caption{Impact des paramètres de régularisation L1/L2 sur l'adoucissement des prédictions (Lasso et Ridge) limitant ainsi le surapprentissage.}
    \label{fig:xgb_reg}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{Chapters/images/xgb_early_stopping.png}
    \caption{Mécanisme d'arrêt prématuré (Early Stopping) stoppant l'apprentissage pour éviter le sur-ajustement.}
    \label{fig:xgb_early_stopping}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapters/images/xgb_histogram_split.png}
    \caption{L'optimisation des histogrammes confinant les données continues ($O(n \log n)$) en classes figées discrètes pour accélérer drastiquement la création des arbres.}
    \label{fig:xgb_hist}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapters/images/xgb_vs_rf_radar.png}
    \caption{Graphique radar récapitulant les forces comparées de XGBoost par rapport au modèle Random Forest sur différentes dimensions.}
    \label{fig:xgb_vs_rf_radar}
\end{figure}
